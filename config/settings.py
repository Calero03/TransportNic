...
from apps.segurida.setting_apps import SEGURIDA_SETTING_APPS
...
SECRET_KEY = 'django-insecure-9b+vcjbt3_yg3e18uc78k)8^@w5z=j50-0a#+%#_2_(qtt6#we'
...
] + SEGURIDA_SETTING_APPS + CATALOGOS_SETTING_APPS
...
DATABASES = {
    'default': {
        ...
        'NAME': 'transporte',  # Nombre de la base de datos
        'HOST': 'LUIS_CALERO\SQLEXPRESS',  # IP del servidor SQL Server
        'OPTIONS': {
